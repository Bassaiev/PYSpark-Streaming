...
object homework {
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read.format("csv")
      ...
      .load("/home/basayev/Downloads/sparkDatas/lifeExpectancyData.csv")
    ...
    val countryStringIndexer = new StringIndexer().setInputCol("Country").setOutputCol("CountryIndexed")
    ...
    // pipeline model
    val pipelineObject = new Pipeline().setStages(Array(statusStringIndexer,countryStringIndexer,encoder,vectorAssembler, linearRegressionObject ))
    ...
    var pIcinNitelikler = numericalCols ++ Array("Status","Country") ++ Array("sabit")
